...
use crate::legacy_core::config::ConfigNamespace;
use crate::legacy_core::config::ConfigOverrides;
use crate::legacy_core::config::find_home;
use crate::legacy_core::config::load_config_as_toml_with_cli_overrides_in_namespace;
...
async fn run_ratatui_app(
    ...
    let mut missing_session_exit = |id_str: &str, action: &str| {
        ...
        Ok(AppExitInfo {
            ...
            exit_reason: ExitReason::Fatal(format!(
                ...
                exe = crate::legacy_core::branding::APP_EXECUTABLE_NAME,
            )),
        })
    };
    ...
    if let Some(w) = crate::render::highlight::set_theme_override(
        ...
        Some(config.codex_home.clone().to_path_buf()),
    ) {
