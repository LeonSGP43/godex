...
use crate::runtime_ui_copy::branded_title_line;
use crate::runtime_ui_copy::session_header_help_lines;
    ...
    fn display_lines(&self, width: u16) -> Vec<Line<'static>> {
        ...
        let content = text![
            line![
                ...
                format!(
                    "{} update available!",
                    crate::legacy_core::branding::APP_PRODUCT_NAME
                )
                .bold()
                .cyan(),
                " ",
    ...
    fn display_lines(&self, width: u16) -> Vec<Line<'static>> {
        ...
        let content = text![
            line![
                ...
                format!(
                    "{} is {} {} ahead",
                    crate::legacy_core::branding::UPSTREAM_PRODUCT_NAME,
                    self.releases_ahead,
                    release_word
                )
                .bold()
...
pub(crate) fn new_session_info(
    ...
    if is_first_event {
        parts.push(Box::new(PlainHistoryCell {
            lines: session_header_help_lines(),
        }));
    } else {
...
impl HistoryCell for SessionHeaderHistoryCell {
    fn display_lines(&self, width: u16) -> Vec<Line<'static>> {
        ...
        let title_spans = branded_title_line("", &self.version).spans;
