...
impl StateRuntime {
    pub async fn create_agent_job_owned(
        self: Arc<Self>,
        params: AgentJobCreateParams,
        items: Vec<AgentJobItemCreateParams>,
...
INSERT INTO agent_job_items (
    ...
    reported_at
        ...
        self.get_agent_job_owned(job_id.clone())
            .await?
...
WHERE id = ?
    ...
    pub async fn get_agent_job_owned(
        self: Arc<Self>,
        job_id: String,
...
WHERE job_id = 
    ...
    pub async fn list_agent_job_items_owned(
        self: Arc<Self>,
        job_id: String,
        status: Option<AgentJobItemStatus>,
        limit: Option<usize>,
...
WHERE job_id = ? AND item_id = ?
    ...
    pub async fn get_agent_job_item_owned(
        self: Arc<Self>,
        job_id: String,
        item_id: String,
    ) -> anyhow::Result<Option<AgentJobItem>> {
...
WHERE id = ?
    ...
    pub async fn mark_agent_job_running_owned(
        self: Arc<Self>,
        job_id: String,
    ) -> anyhow::Result<()> {
        let now = Utc::now().timestamp();
...
WHERE id = ?
    ...
    pub async fn mark_agent_job_completed_owned(
        self: Arc<Self>,
        job_id: String,
    ) -> anyhow::Result<()> {
        let now = Utc::now().timestamp();
...
WHERE id = ?
    ...
    pub async fn mark_agent_job_failed_owned(
        self: Arc<Self>,
        job_id: String,
...
WHERE id = ? AND status IN (?, ?)
    ...
    pub async fn mark_agent_job_cancelled_owned(
        self: Arc<Self>,
        job_id: String,
        reason: String,
    ) -> anyhow::Result<bool> {
...
WHERE id = ?
    ...
    pub async fn is_agent_job_cancelled_owned(
        self: Arc<Self>,
        job_id: String,
    ) -> anyhow::Result<bool> {
        let row = sqlx::query(
...
WHERE job_id = ? AND item_id = ? AND status = ?
    ...
    pub async fn mark_agent_job_item_running_with_thread_owned(
        self: Arc<Self>,
        job_id: String,
        item_id: String,
        thread_id: String,
...
WHERE job_id = ? AND item_id = ? AND status = ?
    ...
    pub async fn mark_agent_job_item_pending_owned(
        self: Arc<Self>,
        job_id: String,
        item_id: String,
...
WHERE
    ...
    pub async fn report_agent_job_item_result_owned(
        self: Arc<Self>,
        job_id: String,
        item_id: String,
...
WHERE
    ...
    pub async fn mark_agent_job_item_completed_owned(
        self: Arc<Self>,
        job_id: String,
        item_id: String,
    ) -> anyhow::Result<bool> {
...
WHERE
    ...
    pub async fn mark_agent_job_item_failed_owned(
        self: Arc<Self>,
        job_id: String,
        item_id: String,
        error_message: String,
...
WHERE job_id = ?
    ...
    pub async fn get_agent_job_progress_owned(
        self: Arc<Self>,
        job_id: String,
    ) -> anyhow::Result<AgentJobProgress> {
        let row = sqlx::query(
            r#"
SELECT
    COUNT(*) AS total_items,
