...
const MULTI_AGENT_TEST_STACK_SIZE_BYTES: usize = 32 * 1024 * 1024;
    ...
    Fut: Future<Output = ()> + 'static,
{
    let handle = std::thread::Builder::new()
        ...
        .stack_size(MULTI_AGENT_TEST_STACK_SIZE_BYTES)
        .spawn(move || {
            let runtime = tokio::runtime::Builder::new_multi_thread()
                .worker_threads(2)
                .thread_stack_size(MULTI_AGENT_TEST_STACK_SIZE_BYTES)
                .enable_all()
                .build()
