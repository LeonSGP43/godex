...
- Compared head: `1710630a84`
- Compared upstream base: `upstream/main` at `d47b755aa2`
- Divergence: `behind 212` / `ahead 95`
- Diff surface: `169 files changed, 18534 insertions(+), 1163 deletions(-)`
...
- Notes:
  ...
  - Latest verification snapshot:
    ...
    - `cargo test -p codex-core 'memories::tests::sync_rollout_summaries_and_raw_memories_file_keeps_latest_memories_only' --manifest-path codex-rs/Cargo.toml -- --exact --nocapture` passed after `1710630a84 refactor(memory): extract rollout summary suffix contract`.
