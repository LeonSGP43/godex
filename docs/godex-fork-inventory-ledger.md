...
- Compared head: `dc682e8edf`
- Compared upstream base: `upstream/main` at `89f1a44afa`
- Divergence: `behind 212` / `ahead 93`
- Diff surface: `169 files changed, 18516 insertions(+), 1156 deletions(-)`
...
- Notes:
  ...
  - Latest verification snapshot:
    ...
    - `cargo test -p codex-core 'memories::tests::sync_rollout_summaries_and_raw_memories_file_keeps_latest_memories_only' --manifest-path codex-rs/Cargo.toml -- --exact --nocapture` passed after `dc682e8edf refactor(memory): extract rollout summary path contract`.
